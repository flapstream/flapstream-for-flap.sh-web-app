...
---
# ![A preview of the BubbleFlap application](./dist/60.png) ![A preview of the BubbleFlap application](./dist/60.png) ![A preview of the BubbleFlap application](./dist/60.png) ![A preview of the BubbleFlap application](./dist/60.png) ![A preview of the BubbleFlap application](./dist/60.png) ![A preview of the BubbleFlap application](./dist/60.png) ![A preview of the BubbleFlap application](./dist/60.png) ![A preview of the BubbleFlap application](./dist/60.png) ![A preview of the BubbleFlap application](./dist/60.png) ![A preview of the BubbleFlap application](./dist/60.png) ![A preview of the BubbleFlap application](./dist/60.png) ![A preview of the BubbleFlap application](./dist/60.png) ![A preview of the BubbleFlap application](./dist/60.png) ![A preview of the BubbleFlap application](./dist/60.png)
## What is FlapStream?
